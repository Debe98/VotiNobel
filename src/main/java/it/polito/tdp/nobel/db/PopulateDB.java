...
public class PopulateDB {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// Aggiungo al DB la seguente lista dei miei esami:
		vd.inserisciEsame(new Esame("16ACFPL", "Analisi matematica I", 10, 27));
		vd.inserisciEsame(new Esame("16AHMPL", "Chimica", 8, 24));
		vd.inserisciEsame(new Esame("12BHDPL", "Informatica", 8, 29));
		//vd.inserisciEsame(new Esame("07LKIPL", "Lingua inglese I livello", 3,));
		vd.inserisciEsame(new Esame("01RKCPL", "Algebra lineare e geometria", 10, 30));
		vd.inserisciEsame(new Esame("01PNNPL", "Crediti liberi del 1 anno", 6, 30));
		vd.inserisciEsame(new Esame("15AXOPL", "Fisica I", 10, 28));

		vd.inserisciEsame(new Esame("23ACIPL", "Analisi matematica II", 8, 27));
		vd.inserisciEsame(new Esame("14AFQPL", "Basi di dati",  8, 30));
		vd.inserisciEsame(new Esame("20AXPPL", "Fisica II", 6, 26));
		vd.inserisciEsame(new Esame("12CKRPL", "Statistica",  10, 30));
		vd.inserisciEsame(new Esame("06ARHPL", "Economia e organizzazione aziendale", 8, 27));
		vd.inserisciEsame(new Esame("07CESPL", "Ricerca operativa", 8, 29));
		vd.inserisciEsame(new Esame("07CHWPL", "Sistemi di produzione", 8, 30));
		vd.inserisciEsame(new Esame("04CIIPL", "Sistemi elettrici industriali", 8, 26));

		vd.inserisciEsame(new Esame("01QNAPL", "Elementi di diritto privato", 8, 23));
		vd.inserisciEsame(new Esame("09CBIPL", "Programmazione a oggetti", 8, 28));
